...
<div class="container mx-auto z-10 pb-8 sm:pb-16 md:pb-20 lg:max-w-2xl lg:pb-28 xl:pb-32">
    ...
    <main class="mt-8 mx-auto max-w-7xl px-4 sm:mt-10 sm:px-6 md:mt-14 lg:mt-18 lg:px-8 xl:mt-24">
