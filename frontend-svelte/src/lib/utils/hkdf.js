 ...
 *
 */
export const encryption = (secret) => hkdf(secret, BYTE_LENGTH, {info: ENCRYPTION_INFO, ...options})
export const signing = (secret) => hkdf(secret, BYTE_LENGTH, {info: SIGNING_INFO, ...options})
