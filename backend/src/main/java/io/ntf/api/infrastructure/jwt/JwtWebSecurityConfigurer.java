...
public class JwtWebSecurityConfigurer {
  ...
  public ServerHttpSecurity configure(ServerHttpSecurity http) {
    ...
    exceptionHandling.setAuthenticationEntryPoint(new JwtReactiveAuthenticationEntryPoint());
    AuthenticationWebFilter authenticationWebFilter = new AuthenticationWebFilter(authenticationManager);
    authenticationWebFilter.setAuthenticationConverter(new JwtAuthenticationConverter());
    ...
    return http
      ...
      .securityContextRepository(new BearerReactiveSecurityConextRepository());
