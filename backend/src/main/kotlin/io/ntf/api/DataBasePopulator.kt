...
//      activityTemplate.copy(name = "activity ten", start = now.minusMonths(0).plusHours(4), end = now.minusMonths(0).plusHours(5).plusMinutes(25))
      activityTemplate.copy(name = "activity 11", start = now.minusMonths(0).plusHours(3).plusMinutes(11), end = now.minusMonths(0).plusHours(4).plusMinutes(10)),
      activityTemplate.copy(name = "activity 14", start = now.minusMonths(0).plusHours(4).plusMinutes(12), end = now.minusMonths(0).plusHours(5).plusMinutes(13)),
      activityTemplate.copy(name = "activity 15", start = now.minusMonths(0).plusHours(5).plusMinutes(14), end = now.minusMonths(0).plusHours(6).plusMinutes(10))
    )
